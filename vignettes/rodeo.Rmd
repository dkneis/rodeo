...
The following Fortran code defines a forcing variable 'temperature' whose time variable values are read from a csv-formatted data file (using comma, blank, or TAB as separator).
